...
import edu.wwcc.CS_241.Jumper.Jonathan.Stack.Stack;
 ...
 * <p>
 * Remember you are always just working with instances of a class not the class itself. The `head` property just points
 * to the first instance of a edu.wwcc.CS_241.Jumper.Jonathan.BinaryTree.BinaryTree.Node class.
 */
